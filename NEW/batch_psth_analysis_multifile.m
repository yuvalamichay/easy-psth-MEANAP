%% BATCH ANALYSIS FOR MULTIPLE FILES (KERNEL DENSITY ESTIMATION FOR PSTH)
% This script loops through a user-defined list of spike and raw file pairs.
% For each pair, it creates a separate output folder and runs the complete
% PSTH analysis, saving all figures and a results file in that folder.
...
baseline_duration_s = 0.02;     % Duration of each baseline window (e.g., 20ms)
