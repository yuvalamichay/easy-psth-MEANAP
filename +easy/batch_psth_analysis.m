...
%% --- USER PARAMETERS ---
spikeFile = 'OWT220207_1H_DIV57_HUB45_5UA_Cspikes_L0_RP2.mat_Nortefact.mat';
rawFile   = 'OWT220207_1H_DIV57_HUB45_5UA.mat';
fs = 25000;
spikeMethod = 'bior1p5';
numChannels = 60;
...
for file_idx = 1:numChannels
    ...
    text(psth_window_ms(1) + 2, plot_ylim(2)*0.9, sprintf('AUC: %.3f', auc), 'FontWeight', 'bold', 'Color','k');
    hold off;
    ylabel('Firing Rate (spikes/s)');
